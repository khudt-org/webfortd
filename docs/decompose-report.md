...
- 신뢰도 분포: high=38, medium=35, low=1
- 평균 본문 길이: 2216자
...
### 제목 직전 라벨을 다음 문서로(3차 검수 34번) (4건)

- `-` — 「[별지 제45호 서식]」 → 「개인정보 수집·이용 및 제공 사전 동의서(서비스 이용자용)」 아래로
- `-` — 「[별지 제8호서식 별지]」 → 「기기이용 장애인 및 신청기기 현황」 아래로
- `-` — 「[별지 제20호 서식]」 → 「보조공학기기 이용 서약서」 아래로
- `-` — 「[별지 제15호 서식]」 → 「개인정보 수집·이용 및 제공 사전 동의서」 아래로
